...
public class Exercises1 extends AppCompatActivity {
    ...
    private void logAndAppend(String lifecycleEvent) {
        android.util.Log.d(TAG, "Lifecycle Event: " + lifecycleEvent);
        log.setInformation(log.getInformation() + lifecycleEvent + "\n");//将信息存到Log的information里，再输出
        mLifecycleDisplay.setText(log.getInformation());
    }
